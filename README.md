...
- ⚙️🏗️ Generate    : Deterministic Code-Generation at Scal
...
**A:** The CLI read the functional design (FDS) from ./inputs/functional-design and generated a.o PLC Code to ./outputs
...
The focus is on food, pharma, fine chemcical and other process manufacturing.   
